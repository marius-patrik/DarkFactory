...
2. *OdbornaPrace-paper*: Repozitář samotného rukopisu této práce reprezentující doménu akademických a odborných textů. Kódová báze kombinuje sazbu v moderním typografickém systému Typst, doprovodné obslužné a validační skripty v Pythonu a plně automatizovanou kompilaci a publikaci PDF na GitHub Pages.
