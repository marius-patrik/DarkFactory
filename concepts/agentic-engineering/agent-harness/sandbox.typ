...
#let terminology = define-term(id: "sandbox", proper: translation(cs: "Izolované běhové prostředí", en: "Sandbox"), industry: translation(cs: "Sandbox", en: "Sandbox"), default-name-type: "both", explanation_cs: "Omezené běhové prostředí určené k oddělení prováděného kódu a jeho oprávnění od hostitelského systému.", explanation_en: "A constrained runtime environment intended to isolate executing code and its permissions from the host system.", keyword: false)
