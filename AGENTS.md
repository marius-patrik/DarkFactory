...
DarkFactory is developed by an autonomous agent pipeline under human approval gates. These rules are
...
- **Project Board Status Taxonomy**: All issues and pull requests are automatically added to the
  DarkFactory GitHub Project with automated status movements:
