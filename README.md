...
| `ADR-0023` | First-party docs use docs.df and one renderer | `DF-RULE-002`, `DF-RULE-003` | [`.agents/notes/adr/0023-first-party-docs-and-one-renderer.md`](.agents/notes/adr/0023-first-party-docs-and-one-renderer.md) |
