...
export interface CreateIssueInput { title: string; body?: string; labels?: string[]; assignees?: string[]; }
export interface UpdateIssueInput { title?: string; body?: string; state?: "open" | "closed"; state_reason?: "completed" | "not_planned" | "reopened"; }
...
export class GitHubRepository {
  ...
  async getPullRequestDiff(number: number, maxBytes = 60_000): Promise<{ text: string; truncated: boolean; bytes: number }> {
