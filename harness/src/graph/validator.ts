...
const nodeSchema = z.discriminatedUnion("kind", [
	base.extend({ kind: z.literal("agent"), identity: z.string().optional(), reasoning: z.enum(["standard", "hard"]).optional(), chain: z.array(z.string()).optional(), timeout: z.string().optional(), iteration: z.object({ context_file: z.string(), safety_budget: z.number().int().positive().optional() }).optional(), quota_policy: z.object({ on_exhaustion: z.literal("checkpoint_and_block"), resume: z.literal("sweep_or_command") }).optional() }),
