...
export interface TaskEstimate { size: TaskSize; contextTokens: number; expectedOutputTokens: number; expectedSteps: number }
export interface CapacityProfile { contextWindow?: number; tier?: ModelTier; reserve?: { requests?: number; tokens?: number } }
...
export function assessCandidate(_candidate: Candidate, task: TaskEstimate, entries: readonly LimitEntry[], profile: CapacityProfile = {}): { eligible: boolean; reason?: "context" | "capacity" | "limited" } {
