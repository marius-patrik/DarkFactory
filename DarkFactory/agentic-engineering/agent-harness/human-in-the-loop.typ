...
Řízení lidského dohledu staví na několika explicitních bodech. První brána se týká záměru a plánu před zahájením zásahů do repozitáře. Druhá brána se týká sémantické kontroly výsledného diffu před začleněním do hlavní historie. Mezi nimi může harness provádět rutinní kroky samostatně, pokud jsou jejich účinky dohledatelné a ověřitelné.
...
Při selhání se nemá modelové vysvětlení zaměňovat za důkaz úspěchu; harness má předat pozorovatelný stav, například diff, chybové hlášení, výsledek kontrol a stav běhu.
  ],
